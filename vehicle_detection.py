...
mpimg.imsave("./output_images/window_sub_sampling.jpg", out_img)
plt.imshow(out_img)
...
for scale in [1, 1.5, 2, 4]:
    boxes.extend(find_boxes(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))

out_img = draw_boxes(img, boxes)
mpimg.imsave("./output_images/multi_window_sub_sampling.jpg", out_img)
plt.imshow(out_img)
...
mpimg.imsave("./output_images/heatmap_detection.jpg", draw_img)
mpimg.imsave("./output_images/heatmap.jpg", heatmap)
